...
public class BookCustomerService implements BaseService<BookCustomerDto> {
	...
	@Override
	public List<BookCustomerDto> getEntities() {
	...
	@Override
	public int getCount() {
		int count = bookCustomerRepository.getCount();
		return count;
	}
}